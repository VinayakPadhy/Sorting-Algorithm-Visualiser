...
class DrawInformation:
    ...
    LARGE_FONT = pygame.font.SysFont('arialblack' , 25)
...
def insertion_sort(draw_info, ascending = True):
    ...
    for i in range(1,len(lst)):
        ...
        while True:
            ascending_sort = current_val < lst[i-1] and i>0 and ascending
            descending_sort = current_val > lst[i-1] and i>0 and not ascending
            ...
            i = i-1
            lst[i] = current_val
            draw_list(draw_info, {i: draw_info.BLUE, i-1: draw_info.MAGENTA}, True)
            yield True
...
def selection_sort(draw_info, ascending = True):
    ...
    for i in range (len(lst) - 1):
        if ascending:
            m_val = min(lst[i:])
            m_index = lst.index(m_val,i)
            if lst[i] != lst[m_index]:
        ...
        draw_list(draw_info, {i: draw_info.BLUE, m_index: draw_info.YELLOW}, True)
        yield True
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.key == pygame.K_r:
                ...
                sorting_algo_name = "Insertion Sort ; Time Complexity: O(n^2) "
            elif event.key == pygame.K_b and not sorting:
                sorting_algorithm = bubble_sort
                sorting_algo_name = "Bubble Sort ; Time Complexity: O(n^2) "
            elif event.key == pygame.K_s and not sorting:
                sorting_algorithm = selection_sort
                sorting_algo_name = "Selection Sort; Time Complexity: O(n^2) "
